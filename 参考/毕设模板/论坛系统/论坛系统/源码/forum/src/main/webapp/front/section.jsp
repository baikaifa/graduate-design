		...
		<div class="main_resize">
			<div class="header">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="/forum/front/section.jsp">版块精选</a></li>
			...
			<div class="content">
				<div class="content_bg">
					<div class="mainbar">
						<div class="article">
           <font size="3" color="#6495ED"><span>|&nbsp;&nbsp;<a  href="/forum/article/section.action?id=1">PHP</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="/forum/article/section.action?id=2">spring</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="/forum/article/section.action?id=3">winform</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="/forum/article/section.action?id=4">C++</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="/forum/article/section.action?id=5">Java</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="/forum/article/section.action?id=6">C#</a>&nbsp;&nbsp;|</span></font><div class="clr"></div>
           	<table width="100%">
								<c:forEach items="${artList}" var="article" varStatus="status">
								
								<tr>

									<td width="50%"><a href="/forum/article/detail.action?id=${article.artId}"><font size="3" color="gray">${article.artTopic}</font></a></td>
                                     <td width="20%">&nbsp;&nbsp;</td>
									<td width="30%"><font size="2" >${article.artPubtime}</font></td>
