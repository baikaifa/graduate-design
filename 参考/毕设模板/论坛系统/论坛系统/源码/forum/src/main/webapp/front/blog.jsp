		...
		<div class="main_resize">
			<div class="header">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="/forum//blog/front.action">博客</a></li>
			...
			<div class="content">
				<div class="content_bg">
					<div class="mainbar">
						<div class="article">
							<font size="5" color="#6495ed">我的博客</font>
							...
							<img src="/forum/front/images/images_1.jpg" width="613"
							 ...
							 <table width="100%">
								...
								<tr>
									...
									<td width="50%"><a href="/forum/article/detail.action?id=${blog.artId}"><font size="3" color="gray">${blog.artTopic}</font></a></td>
									<td width="20%">&nbsp;&nbsp;</td>

									<td><font size="2" >${blog.artPubtime}</font></td>
