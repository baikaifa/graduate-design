...
<div>
    <h3>发表贴子</h3>
    <form action="/forum/article/add.action" method="post">
   ...
   <hr width="70%" height="1px">
    ...
    <input  id="content" type="hidden" name="artContent"/>
    <input  type="submit" value="发表" style="width:60PX" onclick="getContents();"></input>
    </form>
</div>
</center>
