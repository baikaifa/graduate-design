		...
		<div class="main_resize">
			<div class="header">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="/forum/blog/article.action">博文列表</a></li>
			...
			<div class="content">
				<div class="content_bg">
					<div class="mainbar">
						<div class="article">
							<font size="5" color="#6495ed">博文列表</font>

							<div class="clr"></div>
							<p class="post-data">
								<span class="date" style="float: right; margin-right: 20px;"><font size="4" color="#CD0000">我要</font><a href="../ueditor/pubBlog.jsp"><font size="4" color="#CD00CD">发帖</font></a></span>
							</p>
