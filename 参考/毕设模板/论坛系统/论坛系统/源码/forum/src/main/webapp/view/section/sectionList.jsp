                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480">父版块编号</th>
                                            <th class="hidden-480">文章统计</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#">${section.sectionId}</a>
                                            </td>
                                           
                                           <td class="hidden-480">
                                                <span class="label label-sm label-info arrowed arrowed-righ">${section.sectionName}</span>
                                            </td>
                                            <td>${section.sectionMaster}</td>

                                            <td class="hidden-480">
                                                ${section.sectionParentid}
                                            </td>
                                             <td class="hidden-480">
                                                ${section.artCount}
                                            </td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/forum/section/toEdit.action?id=${section.sectionId}">
                                                        <i class="icon-pencil bigger-130"></i>
                                                    </a>

                                                    <a class="red" href="/forum/section/delete.action?id=${section.sectionId}">
