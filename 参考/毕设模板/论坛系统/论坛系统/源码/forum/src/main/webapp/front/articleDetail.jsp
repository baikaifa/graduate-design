      ...
      <div class="mainbar">
        <div class="article">
          ...
          <c:forEach items="${cmtlist}" var="cmt" varStatus="status">
           <p><font color="#6495ED">${cmt.userName}&nbsp;</font>评论:${cmt.commentContent}</p>
          </c:forEach>
          
          
        </div>
        <form action="/forum/comment/add.action" method="post" id="leavereply">
          <ol><li>
            <label for="message">我要评论</label>
            <input type="hidden" name="articleId" value="${art.artId}"/>
            <input type="hidden" name="userName" value="${userName}"/>
            
            <textarea id="message" name="commentContent" rows="8" cols="50"></textarea>
          </li><li>
