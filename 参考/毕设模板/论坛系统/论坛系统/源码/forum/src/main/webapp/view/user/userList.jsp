                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>${user.userName}</td>
                                            <td class="hidden-480">${user.userType}</td>
                                            <td>${user.userRegtime}</td>

                                            <td class="hidden-480">
                                                <span class="label label-sm label-info arrowed arrowed-righ">${user.userState}</span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/forum/user/toEdit.action?id=${user.userId}">
                                                        <i class="icon-pencil bigger-130"></i>
                                                    </a>

                                                    <a class="red" href="/forum/user/delete.action?id=${user.userId}">
