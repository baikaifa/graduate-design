                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>${art.sectionId}</td>
                                            <td class="hidden-480">${art.userId}</td>
                                             <td class="hidden-480">${art.artTopic}</td>
                                            <td>${art.artState}</td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    <a class="blue" href="/forum/article/view.action?id=${art.artId}">
                                                        <i class="icon-zoom-in bigger-130"></i>
                                                    </a>

                                                    <a class="green" href="/forum/user/toEdit.action?id=${art.artId}">
                                                        <i class="icon-pencil bigger-130"></i>
                                                    </a>

                                                    <a class="red" href="/forum/article/delete.action?id=${art.artId}">
